        ...
        <div class="site-navbar bg-light">
          <div class="py-1">
            <div class="row align-items-center">
              ...
              <div class="col-10">
                 <div class="col-2">
                <h2 class="mb-0 site-logo"><a href="index.php" >Admin<strong class="font-weight-bold" >Pannel</strong> </a></h2>
              </div>
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="manageByAdmin.php">HOME</a></li>
...
$password = "";
 ...
 ?>
  ...
  <tr style="color: black">
             ...
             <td>            <a href = "deleteUserByAdmin.php?id=<?php echo$row['id'];?>"><button class="btn btn-danger">Delete</button></a>
</td>
                     <?php endwhile; ?>
