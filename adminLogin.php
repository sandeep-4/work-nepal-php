...
if(checkAdminLogin()){
	redirect('manageByAdmin.php');
}
if(isset($_POST['adminbtn'])){
	$username=$_POST['username'];
	$password=md5($_POST['password']);
	
	$stmtLogin=$conn->prepare("SELECT * FROM adminpannel WHERE username=:username AND password=:password");
...
<hr>
					...
					<div class="container-login100-form-btn m-t-32">
						<button class="login100-form-btn" name="adminbtn">
							Login
						</button>
					</div>
